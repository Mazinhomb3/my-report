        ...
        <table border="0" align="center" id="segunda">
            <tr>
                ...
                while ($row1 = mysqli_fetch_assoc($result)) {
                    ...
                    $sql_verificar = "SELECT id_rede FROM tbl_dados WHERE nome_lider = '" . $row1["lider_cel_rede"] . "' AND cod_lider_rede = '" . $row1["cod_lider_rede"] . "' and data_lider BETWEEN '$dtini' AND TIMESTAMPADD(DAY, 7, '$dtini')";
